...
exports.syncFileName = "agility.json";
...
function route_message(message) {
    ...
    switch (message.type) {
        ...
        case 'save_sync': {
            ...
            lr.writeFile(exports.syncFileName, mv);
        ...
        case 'load_sync': {
            ...
            if (lr.exists(exports.syncFileName)) {
                var txt = lr.readFile(exports.syncFileName);
                exports.worker.postMessage({type: 'load_sync_finish', value: txt});
                env.log('agility.json LOADED');
            } else {
                env.log('agility.json not loaded as it does not exist.');
            }
            return;
        }
