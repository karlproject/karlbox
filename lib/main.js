...
if (!simpleStorage.storage.i_am_working) {
  simpleStorage.storage.i_am_working = {hello: "I am a local storage, and I am working!"};
  env.log('Initializing a new local storage.');
} else {
  env.log('Yes! I found a persistant storage:');
  env.log(simpleStorage.storage.i_am_working.hello);
}
